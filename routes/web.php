...
Route::get('/estadisticas','StatisticsController@getStaticstis' )->name('estadisticas');
...
Route::get('/admin_loan_returnedTool/{loan_id}','LoanController@admin_loan_returnedTool' )->name('admin_loan_returnedTool');
