	...
	<div class="container pt-lg-5 mt-5">
		<div class="row pt-3 pb-lg-0 pb-xl-0">
			<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
				...
				<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Links de interes</h1>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('links.destroy',$link->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('links.show',$link->id) }}"><i class="fa fa-fw fa-eye"></i> </a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('links.edit',$link->id) }}"><i class="fa fa-fw fa-edit"></i> </a>
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Está seguro que quiere borrar el link?')"><i class="fa fa-fw fa-trash"></i> </button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
