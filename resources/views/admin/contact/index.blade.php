	...
	<div class="container pt-lg-5 mt-5">
		<div class="row pt-3 pb-lg-0 pb-xl-0">
			<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
				...
				<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Datos de contacto</h1>
                                ...
                                <tbody>
                                    @foreach ($contacts as $contact)
                                        <tr>
                                            ...
                                            <td>
                                                @if($contact->active)
                                                    <a class="btn btn-sm btn-success" href="{{ route('contacts.edit',$contact->id) }}"> SI</a>
                                                @else
                                                    <a class="btn btn-danger btn-sm" href="{{ route('contacts.edit',$contact->id) }}"> NO</a>
                                                @endif
                                            </td>
