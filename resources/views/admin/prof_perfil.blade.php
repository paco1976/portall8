						...
						<div class="col-md-9">
							...
							<div class="tabs">
                                ...
                                <div class="col-md-4">
                                        ...
                                        @else
                                        <a href="{{ route('prof_avatardelete', ['hash_user' => $user->hash])  }}" class="btn btn-default fileupload-exists" data-dismiss="fileupload">Quitar imagen</a>
                                        @endif
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <a href="{{ route('prof_perfil_edit', ['hash_user' => $user->hash])  }}" class="btn btn-primary" data-dismiss="fileupload">Editar</a>
                                    @endif
