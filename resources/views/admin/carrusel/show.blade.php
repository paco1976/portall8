	...
	<div class="container pt-lg-5 mt-5">
		<div class="row pt-3 pb-lg-0 pb-xl-0">
			<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
				...
				<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Mostrar Carrusel</h1>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="float-left">
                                <span class="card-title">Mostrar Carrusel</span>
                            </div>
                            <div class="float-right">
                                <a class="btn btn-primary" href="{{ route('carrusel.index') }}"> {{ __('Back') }}</a>
                            </div>
                        </div>
