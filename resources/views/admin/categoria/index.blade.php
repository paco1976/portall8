...
<section class="section section-concept section-no-border section-dark section-angled section-angled-reverse pt-5 m-0 overlay overlay-show overlay-op-8" style="background-image: url({{asset('img/slides/slide-bg-4.jpg')}}); background-size: cover; background-position: center; min-height: 645px;">
	...
	<div class="container pt-lg-5 mt-5">
		<div class="row pt-3 pb-lg-0 pb-xl-0">
			<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
				...
				<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Categorias</h1>
	...
	<div role="main" class="main" id='ver'>
					...
					<div class="container">
						...
						<form id="contactForm" action="{{route('admin_categorias')}}" method="get">
						<div class="row">
							<div class="form-group">
								<div class="col-md-12">
									<label>Buscador</label>
									<input type="text" value="" data-msg-required="Ingresa palabra clave." placeholder="ingrese el nombre de la categoría que busca" maxlength="100" class="form-control" name="name" id="name" required>
								</div>
					...
					<div class="row">
						<div class="form-group">
							<div class="col-sm-6">
								<div class="mb-md">
									<a href="{{ route('admin_categoria_new') }}">
							...
							<table class="table table-bordered table-striped mb-none" id="myTable">
								<thead>
									...
									<tr>
										...
										<th style="text-align:center">Super categoría</th>
										<th style="text-align:center"colspan="3">Acciones <br> Activa /Editar / Borrar</th>
									</tr>
								</thead>
								<tbody>
								@foreach($categoria_all as $categoria)
									<tr class="gradeX">
										...
										<td style="text-align:center">{{$categoria->categoriatipo->name }}</td>
										...
										<td style="text-align:center">
											<a href="{{ route('admin_categoria_edit', $categoria->id )}}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
										</td>
										
										<td style="text-align:center">
											<a href="{{ route('admin_categoria_delete', $categoria->id)}}" onclick="return confirm('¿Está seguro/a que quiere borrar la categoría?')" style="text-align:center" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
										</td>
