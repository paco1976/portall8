		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class=" container" style="display: flex; justify-content: space-between;">
						@if(request('visits'))
						<button onclick="toggleFilter('visits')" id="visitsButton" 
						style="border: none; background-color: #dedede; margin: 1px; padding: 20px; border-radius: 5px; cursor: pointer; transition: background-color 0.3s ease;">
						...
						@else
						<button onclick="toggleFilter('visitsMonth')" id="visitsButton" style="border: none; background-color: #f2f2f2; margin: 1px; padding: 20px; border-radius: 5px; cursor: pointer; transition: background-color 0.3s ease;">
							<caption>Visitas del mes</caption>
						</button>
						@endif
