                ...
                <div class="tabs">
                    ...
                    <div class="tab-content">
                        <div id="clave" class="tab-pane active">
                            ...
                            <h2 class="short"><strong>Registro de profesional </strong> en CEFEPERES</h2>
                            <div class="card-body">
                                <form method="POST" action="{{ route('create_profesional') }}" enctype="multipart/form-data" >
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label text-md-right">{{ __('Celular (*)') }} Ej: 1155668899, sin guiones y sin cero delante.</label>
