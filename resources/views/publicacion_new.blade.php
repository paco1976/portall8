	...
	<div class="container pt-3 pb-2">
		...
		<div class="row pt-2">
			...
			<div class="col-lg-9">
				...
				<form role="form" class="needs-validation" action="{{ route('publicacion_save') }}" method="POST" enctype="multipart/form-data" >
					{{ method_field('PUT') }}
					@csrf
					
					<div class="form-group row">
						<label class="col-lg-3 control-label text-lg-end pt-2" for="textareaDefault">Título Principal</label>
							<div class="col-lg-9">
					...
					<div class="form-group row">
						<div class="form-group col-lg-9">
							<a href="{{ route('publicacion') }}" class="btn btn-dark btn-modern float-end" >Volver a Publicaciones</a>
						</div>
