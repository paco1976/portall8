...
<h2 class="font-weight-bold text-5 mb-0">Registrate</h2>
        <div class="row pt-2">
            ...
            <div class="col-lg-9">
                ...
                <form role="form" class="needs-validation"method="POST" action="{{ route('register') }}" enctype="multipart/form-data" >
                    @csrf
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label form-control-label line-height-9 pt-2 text-2">Perfil del Usuario</label>
                        <div class="col-lg-9">
