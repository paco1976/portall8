						...
						<div class="col-md-12">
							<div class="tabs">
								<ul class="nav nav-tabs">
									...
									<li class="active">
                                        <h2 class="font-weight-bold text-5 mb-0">INGRESÁ TU NUEVA CLAVE</h2>
									</li>
                                        ...
                                        @csrf
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input id="email" type="email" class="form-control input-lg @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus readonly>
