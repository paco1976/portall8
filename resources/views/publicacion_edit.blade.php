	...
	<div class="container pt-3 pb-2">
		...
		<div class="row pt-2">
			...
			<div class="col-lg-9">
				...
				<form role="form" class="needs-validation" action="{{ route('publicacion_update') }}" method="POST" enctype="multipart/form-data" >
					{{ method_field('PUT') }}
					@csrf
												...
												<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-hide-info-hover">
													<span class="thumb-info-wrapper">
														...
														<span class="thumb-info-title">
															...
															<a href="{{ route('imagen_delete', $imagen->id) }}" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
														</span>
													</span>
												</span>
												</a>
