															...
															<ul class="nav nav-pills" id="mainNav">
																...
																<li class="dropdown active">
																	...
																	@foreach($categoria_servicios_all as $categoria)
																		<li>
																			<a href="{{ route('homepublicaciones', ['id'=> $categoria->id]) }} ">{{ $categoria->name }}</a>
																		</li>
																	@endforeach
																...
																<li>
																	<a class="nav-link"  href="{{ url('/comunidad') }}">comunidad CFP</a>
																</li>
																<li>
																...
																<li class="dropdown">
																	...
																	<ul class="dropdown-menu">
																		<li class="dropdown">
																			...
																			<a class="dropdown-item" href="{{ route('admin_profesionales') }}"><i class="fa fa-users"></i> Lista de profesionales</a>
																			<a class="dropdown-item" href="{{ route('admin_publicaciones') }}"><i class="fa fa-list-ul"></i> Lista de publicaciones</a>
																			...
																			<a class="dropdown-item" href="#"><i class="fa fa-list"></i> Títulos</a>
																		</li>
																	</ul>
																</li>
																...
																<li class="dropdown">
																	...
																	<ul class="dropdown-menu">
																		...
																		<li class="dropdown">
																			<a href="{{ url('/tarifario') }}"><i class="fa fa-calculator"></i> Tarifarios</a>
																		</li>
																		<li class="dropdown">
																		...
																		<li class="dropdown">
																			<a href="{{ route('toolsList') }}"><i class="bi bi-tools"></i>  Pañol de herramientas</a>
																		</li>
																		<li class="dropdown">
