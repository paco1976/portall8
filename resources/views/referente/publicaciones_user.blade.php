				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12">
							<table class="table table-bordered table-striped mb-none" id="datatable-editable">
								<thead>
									...
									<tr align="center">
										...
										<th style="text-align:center" colspan="2">Publicaciones <br> Activado / ver </th>
									...
									<tr class="gradeX">
										...
										@if($publicacion->cant_consultas>0)
											@if($publicacion->menssage_not_read>0)
												<a href="{{ route('consultas', ['publicacion_hash' => $publicacion->hash]) }}" class="btn btn-success"><strong>{{$publicacion->cant_consultas}}</strong></a>
											@else
												<a href="{{ route('consultas', ['publicacion_hash' => $publicacion->hash]) }}" class="btn btn-success"><strong>{{$publicacion->cant_consultas}}</strong></a>
											@endif
										@else
										...
										<td style="text-align:center">
											<a href="{{ route('publicaciones_aprobar_desaprobar', ['publicacion_hash' => $publicacion->hash]) }}" class="btn btn-danger"> NO </a>
										</td>
										@else
										<td style="text-align:center">
											<a href="{{ route('publicaciones_aprobar_desaprobar', ['publicacion_hash' => $publicacion->hash]) }}" class="btn btn-success">SI</a>
										</td>
										@endif
							...
							<a href="{{ route('profesionales') }}" class="btn btn-primary"> Volver</a>
						</div>
					</div>
