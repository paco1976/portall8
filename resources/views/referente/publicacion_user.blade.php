				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<a href="{{ route('publicaciones_aprobar_desaprobar', ['publicacion_hash' => $publicacion->hash]) }}" class="btn btn-primary btn-lg">
							...
							<!-- {{ route('publicaciones_user', ['user_hash' => $publicacion->user->hash]) }} -->
						</div>
					</div>
				</div>
