                                ...
                                <div class="col-md-8">
                                    ...
                                    <!-- <a href="{{ route('perfil_new') }}" class="btn btn-primary" data-dismiss="fileupload">Completar Perfil</a>-->
                                        ...
                                        <section class="form-group-vertical">
                                            ...
                                            <p>Usted es referente del {{ $user->cfp->name }}. <br><br>
                                            El mail registrado por su CFP para recibir las notificaciones de los mensajes que reciben los profesionales es 
                                            {{ $user->email }} <br><br>
                                            Si desea modificar este mail por favor solicitarlo vía mail a la casilla cefeperes@cfp24.com.ar</p>
