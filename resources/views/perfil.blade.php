            ...
            <div class="container pt-lg-5 mt-5">
                <div class="row pt-3 pb-lg-0 pb-xl-0">
                    <div class="col-lg-6 pt-4 mb-5 mb-lg-0">
                        ...
                        <h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">MI PERFIL</h1>
                    ...
                    <div class="col-lg-3 mt-4 mt-lg-0">
                        ...
                        <aside class="sidebar mt-2" id="sidebar">
                            ...
                            <ul class="nav nav-list flex-column mb-5">
                                ...
                                -->
                                <li class="nav-item"><a class="nav-link text-3 text-dark active" href="#">Mi Perfil</a></li>
                                @if ($user_profile)
                    ...
                    <div class="col-lg-9">
                        ...
                        <form role="form" class="needs-validation">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control text-3 h-auto py-2" type="text" name="name"  value="{{ $user->name }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control text-3 h-auto py-2" type="text" name="last_name" value="{{ $user->last_name }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control text-3 h-auto py-2" type="text" name="dni" value="{{ $user->dni }}" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label form-control-label line-height-9 pt-2 text-2 required">Email</label>
                                <div class="col-lg-9">
                                    <input class="form-control text-3 h-auto py-2" type="text" name="email" value="{{ $user->email }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control text-3 h-auto py-2" type="number" name="mobile" placeholder="Ej: 1155668899, sin guiones y sin cero delante." value="{{ $user_profile->mobile }}" disabled>
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                
                                <label class="col-lg-3 col-form-label form-control-label line-height-9 pt-2 text-2 required">Teléfono</label>
                                <div class="col-lg-9">
                                    
                                    @if ($user_profile->phone )
                                    <input class="form-control text-3 h-auto py-2" type="number" name="phone" value="{{$user_profile->phone}}" disabled>
                                    @else
                                    <input class="form-control text-3 h-auto py-2" type="number" name="lastName" value="SIN DATOS" disabled>
                                    @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input class="form-control text-3 h-auto py-2" type="text" name="facebook" value="{{$user_profile->facebook}}" disabled>    
                                    @else
                                    <input class="form-control text-3 h-auto py-2" type="text" name="facebook" value="SIN DATO" disabled>    
                                    @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input class="form-control text-3 h-auto py-2" type="text" name="instagram" value="{{$user_profile->instagram}}" disabled>    
                                    @else
                                    <input class="form-control text-3 h-auto py-2" type="text" name="instagram" value="SIN DATO" disabled>    
                                    @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <a href="{{ route('perfil_edit') }}" class="btn btn-primary btn-modern float-end" data-loading-text="Cargando...">Editar</a>
                                </div>
                            </div>
                        </form>
