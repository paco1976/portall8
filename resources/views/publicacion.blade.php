		...
		<div class="container pt-lg-5 mt-5">
			<div class="row pt-3 pb-lg-0 pb-xl-0">
				<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
					...
					<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">MIS PUBLICACIONES</h1>
			...
			<div class="col-lg-3 mt-4 mt-lg-0">
				...
				<aside class="sidebar mt-2" id="sidebar">
					...
					<ul class="nav nav-list flex-column mb-5">
						...
						<li class="nav-item"><a class="nav-link text-3 text-dark active" href="{{ route('publicacion') }}">Publicaciones</a></li>
		...
		<section class="card card-admin">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-sm-6">
						<div class="mb-3">
							<a href="{{ route('publicacion_new') }}" class="btn btn-primary">Agregar publicación <i class="fas fa-plus"></i></a>
				...
				<table class="table table-bordered table-striped mb-0" id="datatable-editable">
					...
					<tbody>
						...
						<tr data-item-id="1">
							...
							<td class="actions">
								<a href="{{ route('publicacion_edit', ['publicacion_hash'=> $publicacion->hash]) }}" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
								<a href="{{ route('publicacion_delete', ['hash'=> $publicacion->hash]) }}" class="btn btn-danger" onclick="return confirm('Está seguro que quiere borrar la publicación?')" ><i class="far fa-trash-alt"></i></a>
								<!--
