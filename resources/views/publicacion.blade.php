								...
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>
											<a href="{{ route('publicacion_delete', ['hash'=> $publicacion->hash]) }}" class="btn btn-danger" onclick="return confirm('Está seguro que quiere borrar la publicación?')" ><i class="fa fa-trash"></i></a>
